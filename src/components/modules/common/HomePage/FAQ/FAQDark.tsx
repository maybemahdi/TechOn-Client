...
export default function FAQDark() {
  ...
  return (
    <section id="faq" className="py-16 px-4 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-gray-200">
      <div className="container py-12 mx-auto border-2 border-orange-500/70 rounded-lg">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <span className="inline-block bg-indigo-500/20 text-indigo-400 px-4 py-2 rounded-full text-lg font-medium mb-4">
